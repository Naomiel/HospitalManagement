...
public class ItemQuery {
    public static final String INSERT_ITEM = """
            ...
            VALUES (:itemMedicationSalesId, :itemMedicationId, :itemQuantity, COALESCE(:itemStatus,'ACTIVE'), GETDATE(), GETDATE())
            """;
    public static final String UPDATE_ITEM = "UPDATE Item SET itemMedicationSalesId = ?, itemMedicationId = ?, itemQuantity = ?, itemUpdatedAt = GETDATE() WHERE itemId = :itemId";
